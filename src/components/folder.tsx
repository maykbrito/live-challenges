...
export function Folder({title, children, defaultOpen = false}: FolderProps) {
  ...
  return (
    <Collapsible.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Collapsible.Trigger className="flex items-center gap-2 px-2 py-1 w-full border rounded-sm   border-transparent text-slate-200 text-xs hover:bg-gray-800 hover:text-[#E0DEF2] focus:bg-gray-800 focus:border-[#363247] focus:text-[#e0def2] outline-none">
